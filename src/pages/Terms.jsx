...
const SECTIONS = [
  ...
  { id: 'pricing', title: '4. Pricing',
    body: 'Esports Elite is currently free to use with full feature access. Paid plans may be introduced in the future; existing users will be notified in advance of any pricing changes affecting their account.' },
