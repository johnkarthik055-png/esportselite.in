/* ============================================================
   ...
   Erangel (vehicle + boat) and Miramar (vehicle + boat) all have
   verified datasets now. All Rondo spawn data does NOT — the only
   file received under that label turned out to be a duplicate of
   Erangel's vehicle list, and was rejected rather than wired in.
   Consumers must show an explicit "data unavailable" state for
   Rondo instead of falling back to another map's coordinates.
